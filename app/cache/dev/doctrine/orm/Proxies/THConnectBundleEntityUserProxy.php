 ...
 */
class THConnectBundleEntityUserProxy extends \TH\ConnectBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setFbUsername($fb_username);
    }
    ...
    {
        $this->__load();
        return parent::getNativeLanguage();
    }

    public function setNativeLanguage($language)
    {
        $this->__load();
        return parent::setNativeLanguage($language);
    }

    public function getLearningLanguage()
    {
        $this->__load();
        return parent::getLearningLanguage();
    }

    public function setLearningLanguage($language)
    {
        $this->__load();
        return parent::setLearningLanguage($language);
    }
    ...
    public function addInterest(\TH\ConnectBundle\Entity\Interest $interest)
    {
        $this->__load();
    ...
    {
        return array('__isInitialized__', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'lastLogin', 'locked', 'expired', 'expiresAt', 'confirmationToken', 'passwordRequestedAt', 'roles', 'credentialsExpired', 'credentialsExpireAt', 'id', 'fb_username', 'firstname', 'lastname', 'facebookId', 'native_language', 'learning_language', 'interests');
    }
